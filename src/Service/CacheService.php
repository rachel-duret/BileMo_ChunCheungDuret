...
class CacheService
{
    ...
    public function cache($request, $repository, string $getGroups, string $entityCache)
    {
        ...
        $jsonUserList = $this->cachePool->get($cacheId, function (ItemInterface $item) use ($repository, $page, $limit,  $getGroups, $entityCache) {
